...
const navNew =
  '<a href="services.html">Services</a><a href="pricing.html">Pricing</a><a href="estimator.html">Estimator</a><a href="recent-jobs.html">Recent jobs</a><a href="areas.html">Areas</a><a href="guides.html">Guides</a><a href="reviews.html">Reviews</a><a href="contact.html">Book</a>';
...
const pages = [
  ...
  },
  {
    ...
    title: "Mobile OBD Diagnostics Feltham | Warning Light Checks | Tuned Performance",
    description: "Mobile OBD diagnostic enquiries in Feltham for warning lights, fault symptoms, MOT issues and next-step repair guidance.",
    keywords: "mobile OBD diagnostics Feltham, warning light check Feltham, car diagnostic Feltham, engine light diagnostic TW13, OBD scan Feltham",
    crumbs: [{ name: "OBD Diagnostics Feltham", href: "mobile-obd-diagnostics-feltham.html" }],
    eyebrow: "Diagnostics Feltham",
    h1: "Mobile OBD diagnostics for warning lights in Feltham",
    ...
    mainParagraphs: [
      "Drivers searching for OBD diagnostics usually need a fast answer and a clear next step. This page is built to capture that search intent and route it into the estimator or contact form.",
    ...
    cards: [
      { h: "Warning lights", p: "Engine light, ABS, airbag, emissions and other warnings should be described clearly.", links: [{ href: "obd-diagnostics.html", text: "Diagnostics service" }] },
    ...
    service: { type: "Mobile OBD diagnostics in Feltham", price: "35" },
    faqs: [
      ["Does an OBD scan fix the fault?", "No. An OBD scan gives fault code guidance and next steps. Repair work depends on what the diagnostic information shows."],
...
const popularLocalSection = `      <section class="section section-dark" aria-labelledby="popular-searches-title">
        ...
        <div class="container content-grid"><article class="detail-card"><h3>Bumper repair Feltham</h3><p>Photo-led bumper scuff and scratch quote route for local drivers.</p><a href="bumper-repair-feltham.html">Open bumper page</a></article><article class="detail-card"><h3>Panel respray Feltham</h3><p>Single panel repair and re-spray guidance for scratches and paint damage.</p><a href="single-panel-respray-feltham.html">Open panel page</a></article><article class="detail-card"><h3>OBD diagnostics Feltham</h3><p>Warning light and fault scan enquiry route before MOT or repair work.</p><a href="mobile-obd-diagnostics-feltham.html">Open diagnostics page</a></article><article class="detail-card"><h3>BMW/MINI coding Feltham</h3><p>BimmerCode-supported hidden feature and comfort coding compatibility checks.</p><a href="bmw-mini-coding-feltham.html">Open coding page</a></article></div>
      </section>
...
const areaServiceSection = `      <section class="section section-light" aria-labelledby="area-service-searches-title"><div class="container section-heading"><p class="eyebrow">Service searches</p><h2 id="area-service-searches-title">High-intent Feltham service pages</h2><p>These pages target specific local queries and link customers directly to pricing, estimator and contact routes.</p></div><div class="container content-grid"><article class="detail-card"><h3>Bumper repair Feltham</h3><p>For bumper scuffs, paint transfer and scratch quote requests.</p><a href="bumper-repair-feltham.html">Bumper repair</a></article><article class="detail-card"><h3>Panel respray Feltham</h3><p>For single panel repair and re-spray enquiries.</p><a href="single-panel-respray-feltham.html">Panel respray</a></article><article class="detail-card"><h3>Diagnostics Feltham</h3><p>For warning lights, OBD scans and MOT-related faults.</p><a href="mobile-obd-diagnostics-feltham.html">Diagnostics</a></article><article class="detail-card"><h3>BMW/MINI coding Feltham</h3><p>For supported hidden factory feature coding.</p><a href="bmw-mini-coding-feltham.html">Coding</a></article></div></section>
`;
...
const servicesIntentSection = `      <section class="section section-light" aria-labelledby="service-intent-title"><div class="container section-heading"><p class="eyebrow">Local search pages</p><h2 id="service-intent-title">Service pages for specific Feltham searches</h2><p>Use these pages when the customer already knows the service they want and is searching locally.</p></div><div class="container content-grid"><article class="detail-card"><h3>Bumper repair Feltham</h3><p>Scuffs, scratches and minor bumper damage quote route.</p><a href="bumper-repair-feltham.html">Bumper repair Feltham</a></article><article class="detail-card"><h3>Single panel respray Feltham</h3><p>Panel paint repair and re-spray enquiry route.</p><a href="single-panel-respray-feltham.html">Panel respray Feltham</a></article><article class="detail-card"><h3>Mobile OBD diagnostics Feltham</h3><p>Warning light, MOT and fault scan enquiry route.</p><a href="mobile-obd-diagnostics-feltham.html">Diagnostics Feltham</a></article><article class="detail-card"><h3>BMW/MINI coding Feltham</h3><p>BimmerCode supported coding and hidden feature checks.</p><a href="bmw-mini-coding-feltham.html">Coding Feltham</a></article></div></section>
`;
